...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Rahat") || (event.body.toLowerCase() == "Rahat vai") || (event.body.toLowerCase() == "@rahat islam") || (event.body.toLowerCase() == "রাহাত")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:ULLASH ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রাহাদ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Riya Moni") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ ম্যানশন দিবানা এটা আমার বস রাহাদ এর gf হয়😾😠", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Riya Moni") || (event.body.toLowerCase() == "Riya")) {
     return api.sendMessage("আমার রাহাদ বসের জিএফ😒 ওরে আরেকবার ডাক দিলে মার দিমু আবাল😾😒", threadID);
   };
